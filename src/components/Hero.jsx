...
const Hero = () => {
  return (
    <div className="relative w-full h-screen flex items-center font-serif justify-center bg-gradient-to-b from-black via-[#0f0e17] to-[#1a1a2e] text-white overflow-hidden">
      ...
      {/* Content Section */}
      <div className="absolute top-1/2 transform -translate-y-1/2 max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-2xl text-center space-y-6 px-4 sm:px-6 lg:px-8 mt-3">
